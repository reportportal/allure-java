# Report Portal Allure integration for Cucumber 6 framework
## Installation
...
Allure features you need to include our agent into your dependencies and setup Cucumber 6 reporter.
### Gradle
```groovy
dependencies {
