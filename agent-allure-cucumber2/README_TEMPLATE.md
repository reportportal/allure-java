# Report Portal Allure integration for Cucumber 2 framework
## Installation
...
Allure features you need to include our agent into your dependencies and setup Cucumber 2 reporter.
### Gradle
```groovy
dependencies {
  testImplementation 'com.epam.reportportal:agent-allure-cucumber2:$LATEST_VERSION'
}
```
...
<dependency>
    ...
    <artifactId>agent-allure-cucumber2</artifactId>
