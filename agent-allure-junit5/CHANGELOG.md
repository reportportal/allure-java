...
## [5.4.2]
### Changed
- Agent version updated on [5.5.8](https://github.com/reportportal/agent-java-junit5/releases/tag/5.5.8), by @HardNorth

## [5.4.1]
### Changed
- Agent version updated on [5.5.7](https://github.com/reportportal/agent-java-junit5/releases/tag/5.5.7), by @HardNorth

## [5.4.0]
### Changed
- Agent version updated on [5.5.2](https://github.com/reportportal/agent-java-junit5/releases/tag/5.5.2), by @HardNorth
